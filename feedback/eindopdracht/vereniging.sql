...
--
-- Host: localhost
-- Gegenereerd op: 29 dec 2022 om 11:41
-- Serverversie: 8.0.30
-- PHP-versie: 7.4.32
...
(52, 'editt', 'ttide', '1111AA', '188'),
(53, 'Ganondorf', 'Evil', '1111AA', '2121'),
(56, 'Toevoegen', 'Lid', '9012EF', '4321');
...
('0000ZZ', 'zeepstraat 1', 'Timboektoe'),
...
('LoremIpsum', 'fillers'),
('nieuwTeam', 'toevoegen team werkt'),
...
--
ALTER TABLE `leden`
  MODIFY `lidnummer` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;

--
-- AUTO_INCREMENT voor een tabel `teamlid`
--
ALTER TABLE `teamlid`
  MODIFY `tl_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
